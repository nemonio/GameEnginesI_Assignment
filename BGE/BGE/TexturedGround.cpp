...
TexturedGround::TexturedGround(void) :GameComponent()
{
	width = 5000;
	height = 5000;
}
...
TexturedGround::~TexturedGround(void)
{
}

bool TexturedGround::Initialise()
{
	if (initialised)
	{
		return true;
	...
	textureID = Content::LoadTexture("GrassTexture");
